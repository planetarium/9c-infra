...
function senderr() {
  echo "$1"
  curl --data "[K8S] $1. Check snapshot-full-$VERSION_NUMBER in 9c-main cluster at upload_snapshot.sh." "https://planetariumhq.slack.com/services/hooks/slackbot?token=$SLACK_TOKEN&channel=%239c-mainnet"
}
